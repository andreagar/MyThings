...
public class frmModificarTarea extends JFrame implements ActionListener{
	 ...
	 * @param tarea 
	 */
	public frmModificarTarea(Tareas tarea) {
		setResizable(false);
		tarea1 = tarea;
		...
		TiempoViaje.setSelectedIndex(opc);
		...
		txtLocalizacion.setText(tarea.getLocalizacion());
		...
		String opcion1 = tarea.getImportancia();
		int opc1 = 0;
		if(opcion1.equals("Alta")) opc1=0;
		if(opcion1.equals("Media")) opc1=1;
		if(opcion1.equals("Baja")) opc1=2;
		...
		Importancia.setSelectedIndex(opc1);
	...
	public void actionPerformed(ActionEvent e) {
		...
		switch (e.getActionCommand()) {
			...
			try{
				...
				if (tareas.ModificarTarea(fechai, fechaf, String.valueOf(Importancia.getSelectedItem()), txtLocalizacion.getText() , opc, txtDescripcion.getText(), tarea1))
				{
					frmModificarTarea.this.dispose();
